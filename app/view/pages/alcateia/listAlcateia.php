...
<div class="container-fluid pt-4">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-md-3 pb-4">
      <a class="card text-center card-sweg" href="<?=BASEURL ?>/controller/AcessoController.php?controller=Matilha&action=listMatilha&idAlcateia=<?= $alc->getIdAlcateia(); ?>&nomeAlcateia=<?= $alc->getNome(); ?>">          
        <div class="card-body btn">
          <p class="card-text text-center">
            <img class="incons_redirecionais" src="<?= BASEURL ?>/view/pages/home/images/matilha.png" alt="">
          </p>
          <div class="card-sweg-details">
            <h5 class="card-title"> <?= $alc->getNome();?></h5>
          </div>  
        </div>  
      </a>
    </div>
