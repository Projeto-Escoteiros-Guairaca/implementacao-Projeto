                ...
                <div id="descricao">
                    ...
                    <?php foreach ($dados["usuarios"] as $usu) : ?>
                        <button class=" btn_verde">
                            <a class="a_bugs" href="<?= BASEURL ?>/controller/MatilhaController.php?action=definePrimo&isForm&idMatilha=<?= $dados['matilha']->getIdMatilha() ?>&id=<?= $usu->getId() ?>"><strong> Definir Como primo </strong></a>
                        </button>
                        ...
                        <button class="btn_azul">
                            <a href="<?= BASEURL ?>/controller/AcessoController.php?controller=Usuario&action=profile&id=<?= $usu->getId() ?>">Dados do Lobinho</a>
                        </button>
                        <hr>
                    <?php endforeach; ?>
                </div>
