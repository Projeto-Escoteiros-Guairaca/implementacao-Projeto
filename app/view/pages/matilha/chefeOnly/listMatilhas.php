                ...
                <div class="card my-2 mx-2" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a class="btn_cards my-1" href="<?= BASEURL ?>/controller/AcessoController.php?controller=Matilha&action=edit&id=<?php echo $alc->getIdMatilha(); ?>&idAlcateia=<?= $dados['alcateia'][0]; ?>&nomeAlcateia=<?= $dados['alcateia'][1]; ?>">
                            <strong>Editar Matilha</strong></a>
                        <br>
                        <br>

                        <a class="btn_cards a_bugs" href="<?= BASEURL ?>/controller/AcessoController.php?controller=Matilha&action=listMatilhas&idMatilha=<?= $alc->getIdMatilha() ?>&idAlcateia=<?= $dados['alcateia'][0]; ?>&nomeAlcateia=<?= $dados['alcateia'][1]; ?>">
                            <strong> Mostrar Dados da Matilha:</strong></a>
