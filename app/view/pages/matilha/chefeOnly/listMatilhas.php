                ...
                <?php foreach ($dados["lista"] as $alc) : ?>
                    <div class="card my-2 mx-2" style="width: 18rem;">
                        ...
                        <button class="btn_azul">
                            <a class="a_bugs" href="<?= BASEURL ?>/controller/AcessoController.php?controller=Matilha&action=listMatilhas&idMatilha=<?= $alc->getIdMatilha() ?>&idAlcateia=<?= $dados['alcateia'][0]; ?>&nomeAlcateia=<?= $dados['alcateia'][1]; ?>">
