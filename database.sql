...
CREATE TABLE tb_usuarios ( 
  ...
  CONSTRAINT uk_usuarios_cpf UNIQUE (cpf) -- CORREÇÃO: Alterado de login para cpf
);
...
/*Inserts enderecos*/
INSERT INTO tb_enderecos (cep, logradouro, numero_endereco, bairro, cidade, pais) VALUES 
('00000000', 'Rua 1', 1, 'Bairro 1', 'Cidade 1', 'Pais 1'),
('11111111', 'Rua 2', 2, 'Bairro 2', 'Cidade 2', 'Pais 2'),
('11111111', 'Rua 2', 2, 'Bairro 2', 'Cidade 2', 'Pais 2'),
('11111111', 'Rua 2', 2, 'Bairro 2', 'Cidade 2', 'Pais 2'),
('11111111', 'Rua 2', 2, 'Bairro 2', 'Cidade 2', 'Pais 2'),
('11111111', 'Rua 2', 2, 'Bairro 2', 'Cidade 2', 'Pais 2');
...
/*Inserts contatos*/
INSERT INTO tb_contatos (telefone, celular, email) VALUES 
('11111111', '11111111111', 'emailAdmin@gmail.com'),
('22222222', '22222222222', 'emailRoot@gmail.com'),
('33333333', '33333333333', 'Markinhos@gmail.com'),
('44444444', '44444444444', 'chefinho@gmail.com'),
('55555555', '44444444444', 'chefinho2@gmail.com'),
('66666666', '44444444444', 'chefinho3@gmail.com');

/*Inserts usuarios*/
INSERT INTO tb_usuarios (id_endereco, id_contato, id_matilha, nome, cpf, email, senha, papeis, status_usuario) VALUES
(1, 1, 1, 'Sr. Administrador', '11122233344', 'admin@gmail.com', 'admin', 'ADMINISTRADOR', 'ATIVO'),
(2, 2, 1, 'Sr. Root', '44433322211', 'root@gmail.com', 'root', 'LOBINHO', 'ATIVO'),
(3, 3, 2, 'Marco', '69669669669', 'marco@gmail.com', 'marco', 'CHEFE', 'ATIVO'),
(4, 4, 1, 'chefe1', '50947509203',  'chefe1@gmail.com', 'chefe1', 'CHEFE', 'ATIVO'),
(5, 5, 2, 'chefe2', '50947509205', 'chefe2@gmail.com', 'chefe2', 'CHEFE', 'ATIVO'),
(6, 6, 3, 'chefe3', '50947509206', 'chefe3@gmail.com', 'chefe3', 'CHEFE', 'ATIVO');


/* CORREÇÃO AQUI: Removido valor duplicado e ajustada a estrutura */
INSERT INTO tb_usuarios (id_endereco, id_contato, id_matilha, nome, cpf, email, senha, papeis, status_usuario) VALUES 
(6, 6, 3, 'chefe4', '50947509207', 'chefe4@gmail.com', 'chefe4', 'CHEFE', 'ATIVO');
...
/* AGORA adicionamos a FK em usuarios, depois de ter criado as matilhas */
